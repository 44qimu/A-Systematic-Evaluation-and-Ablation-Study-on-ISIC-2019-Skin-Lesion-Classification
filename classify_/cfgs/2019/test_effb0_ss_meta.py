...
def init(mdlParams_):
    ...
    mdlParams['saveDir'] = mdlParams_['pathBase']+'/data/saveDir/'
    # Data is loaded from here
    mdlParams['dataDir'] = mdlParams_['pathBase']+'/data/dataDir'
    ...
    mdlParams['learning_rate'] = 1.5e-5#*len(mdlParams['numGPUs'])
    ...
    mdlParams['training_steps'] = 15 #250
    ...
    mdlParams['model_load_path'] = mdlParams['saveDir'] + '2019.test_effb0_ss'
